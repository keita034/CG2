#include"Model.h"
//パイプラインステート
Microsoft::WRL::ComPtr<ID3D12PipelineState> Model::pipelineState = nullptr;
//ルートシグネチャ
ID3D12RootSignature* Model::rootSignature = nullptr;
//SRVの最大個数
...
void Model::Update(const MyMath::Vector3& pos, const MyMath::Vector3& rot, const MyMath::Vector3& scale, const MyMath::Vector4& color)
{
	//カラー
	for (int i = 0; i < 4; i++)
	{
...
void Model::CreateCube()
{
	...
	//デスクプリタレンジの生成
	if (descriptorRange.NumDescriptors == 0)
	{
	...
	{
		//正面
		{{-1.0f,-1.0f,-1.0f},{ 0.0f, 1.0f},{1.0f,1.0f,1.0f,1.0f}},//左上インデックス0
		{{-1.0f, 1.0f,-1.0f},{ 0.0f, 0.0f},{1.0f,1.0f,1.0f,1.0f}},//左下インデックス1
		{{ 1.0f,-1.0f,-1.0f},{ 1.0f, 1.0f},{1.0f,1.0f,1.0f,1.0f}},//右上インデックス2
		{{ 1.0f, 1.0f,-1.0f},{ 1.0f, 0.0f},{1.0f,1.0f,1.0f,1.0f}},//右下インデックス3

		//右
		{{ 1.0f,-1.0f,-1.0f},{ 0.0f, 1.0f},{1.0f,1.0f,1.0f,1.0f}},//左上インデックス4
		{{ 1.0f, 1.0f,-1.0f},{ 0.0f, 0.0f},{1.0f,1.0f,1.0f,1.0f}},//左下インデックス5
		{{ 1.0f,-1.0f, 1.0f},{ 1.0f, 1.0f},{1.0f,1.0f,1.0f,1.0f}},//右上インデックス6
		{{ 1.0f, 1.0f, 1.0f},{ 1.0f, 0.0f},{1.0f,1.0f,1.0f,1.0f}},//右下インデックス7

		//左
		{{-1.0f,-1.0f, 1.0f},{ 0.0f, 1.0f},{1.0f,1.0f,1.0f,1.0f}},//左上インデックス8
		{{-1.0f, 1.0f, 1.0f},{ 0.0f, 0.0f},{1.0f,1.0f,1.0f,1.0f}},//左下インデックス9
		{{-1.0f,-1.0f,-1.0f},{ 1.0f, 1.0f},{1.0f,1.0f,1.0f,1.0f}},//右上インデックス10
		{{-1.0f, 1.0f,-1.0f},{ 1.0f, 0.0f},{1.0f,1.0f,1.0f,1.0f}},//右下インデックス11

		//裏
		{{ 1.0f,-1.0f, 1.0f},{ 0.0f, 1.0f},{1.0f,1.0f,1.0f,1.0f}},//左上インデックス12
		{{ 1.0f, 1.0f, 1.0f},{ 0.0f, 0.0f},{1.0f,1.0f,1.0f,1.0f}},//左下インデックス13
		{{-1.0f,-1.0f, 1.0f},{ 1.0f, 1.0f},{1.0f,1.0f,1.0f,1.0f}},//右上インデックス14
		{{-1.0f, 1.0f, 1.0f},{ 1.0f, 0.0f},{1.0f,1.0f,1.0f,1.0f}},//右下インデックス15

		//上
		{{-1.0f, 1.0f,-1.0f},{ 0.0f, 1.0f},{1.0f,1.0f,1.0f,1.0f}},//左上インデックス16
		{{-1.0f, 1.0f, 1.0f},{ 0.0f, 0.0f},{1.0f,1.0f,1.0f,1.0f}},//左下インデックス17
		{{ 1.0f, 1.0f,-1.0f},{ 1.0f, 1.0f},{1.0f,1.0f,1.0f,1.0f}},//右上インデックス18
		{{ 1.0f, 1.0f, 1.0f},{ 1.0f, 0.0f},{1.0f,1.0f,1.0f,1.0f}},//右下インデックス19

		//底
		{{-1.0f,-1.0f, 1.0f},{ 0.0f, 1.0f},{1.0f,1.0f,1.0f,1.0f}},//左上インデックス20
		{{-1.0f,-1.0f,-1.0f},{ 0.0f, 0.0f},{1.0f,1.0f,1.0f,1.0f}},//左下インデックス21
		{{ 1.0f,-1.0f, 1.0f},{ 1.0f, 1.0f},{1.0f,1.0f,1.0f,1.0f}},//右上インデックス22
		{{ 1.0f,-1.0f,-1.0f},{ 1.0f, 0.0f},{1.0f,1.0f,1.0f,1.0f}},//右下インデックス23

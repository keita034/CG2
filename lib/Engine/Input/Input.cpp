...
const MyMath::Vector3 Input::GetMouseMove()
{
...
bool Input::StickTrigger(ControllerStick stickInput, const float& deadRange, const MyMath::Vector2& deadRate)
{
...
bool Input::StickInput(ControllerStick stickInput, const float& deadRange, const MyMath::Vector2& deadRate)
{
...
bool Input::StickOffTrigger(ControllerStick stickInput, const float& deadRange, const MyMath::Vector2& deadRate)
{

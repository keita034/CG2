...
bool Controller::StickTrigger(ControllerStick stickInput, const float& deadRange, const MyMath::Vector2& deadRate)
{
...
bool Controller::StickInput(ControllerStick stickInput, const float& deadRange, const MyMath::Vector2& deadRate)
{
	MyMath::Vector2 vec;
	bool isLeftStick = stickInput <= L_RIGHT;
...
bool Controller::StickOffTrigger(ControllerStick stickInput, const float& deadRange, const MyMath::Vector2& deadRate)
{
	MyMath::Vector2 oldVec;
	MyMath::Vector2 vec;
	bool isLeftStick = stickInput <= L_RIGHT;

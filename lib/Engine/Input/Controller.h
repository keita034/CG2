...
public:
	...
	bool StickTrigger(ControllerStick stickInput, const float& deadRange = 0.3f, const MyMath::Vector2& deadRate = { 1.0f,1.0f });
	...
	/// <param name="deadRate">デッドゾーン判定の度合い初期値1.0f</param>
	/// <returns>倒したかどうか</returns>
	bool StickInput(ControllerStick stickInput, const float& deadRange = 0.3f, const MyMath::Vector2& deadRate = { 1.0f,1.0f });
	...
	/// <param name="deadRate">デッドゾーン判定の度合い初期値1.0f</param>
	/// <returns>離したか</returns>
	bool StickOffTrigger(ControllerStick stickInput, const float& deadRange = 0.3f, const MyMath::Vector2& deadRate = { 1.0f,1.0f });
